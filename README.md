# Npgsql.FSharp.GeoJSON [![Nuget](https://img.shields.io/nuget/v/Npgsql.FSharp.GeoJSON.svg?colorB=green)](https://www.nuget.org/packages/Npgsql.FSharp.GeoJSON) [![Build Status](https://travis-ci.com/Zaid-Ajaj/Npgsql.FSharp.GeoJSON.svg?branch=master)](https://travis-ci.com/Zaid-Ajaj/Npgsql.FSharp.GeoJSON)

Thin F#-friendly layer for the [Npgsql](https://github.com/npgsql/npgsql) data provider for PostgreSQL.

For an optimal developer experience, this library is made to work with [Npgsql.FSharp.GeoJSON.Analyzer](https://github.com/Zaid-Ajaj/Npgsql.FSharp.GeoJSON.Analyzer) which is a F# analyzer that will verify the query syntax and perform type-checking against the parameters and the types of the columns from the result set.
...
```fs
open Npgsql.FSharp.GeoJSON
open Npgsql.FSharp.GeoJSON.OptionWorkflow
